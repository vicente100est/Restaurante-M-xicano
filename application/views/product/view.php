 ...
 <section class="wrapper">
  ...
  <div class="col-sm-12">
   ...
   <div class="card">
    ...
    <h4 class="card-subtitle text-muted"><?=label('Product');?></h4>
             ...
             <?php foreach ($products as $product):?>
              <tr>
                 ...
                 <td><div class="btn-group">
                       ...
                       <a class="btn btn-primary" href="products/edit/<?=$product->id;?>" data-toggle="tooltip" data-placement="top" title="<?=label('Edit');?>"><i class="fa fa-pencil"></i></a>
                       <?php if($this->user->role === "admin" && $product->type === 0 ){?><a class="btn btn-success" href="javascript:void(0)" onclick="modifystock(<?=$product->id;?>)"><i class="fa fa-tasks" data-toggle="tooltip" data-placement="top"  title='<?=label("ModifyStock");?>'></i></a><?php } ?>
