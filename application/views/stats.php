 ...
 <section class="wrapper">
  ...
  <div class="col-sm-12">
   ...
   <div class="card">
    ...
    <h4 class="card-subtitle text-muted">REPORTES</h4>
   ...
   <div class="row" style="margin-top:50px;">
      <div class="col-md-6">
         ...
         <div class="statCart">
            ...
            <div style="width:100%">
               <canvas id="canvas" height="243"></canvas>
            </div>
         </div>
      </div>
      <div class="col-md-5">
...
<div class="panel panel-default">
	<div class="panel-body">
        <div class="row rangeStat" style="margin-top:50px;">
            <h3 class="col-sm-12"><i class="fa fa-user"></i> <?=label('ClientsStats');?></h3>
            <div class="col-md-5">
...
<div class="panel panel-default">
    <div class="panel-body">
       <div class="row rangeStat" style="margin-top:50px;">
          <h3 class="col-sm-12"><i class="fa fa-archive"></i> <?=label('ProductsStats');?></h3>
          <div class="col-md-5">
             <div class="form-group">
...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="row rangeStat" style="margin-top:50px;">
          <h3 class="col-sm-12"><i class="fa fa-line-chart"></i> <?=label('RegisterStats');?></h3>
          <div class="col-md-5">
             <div class="form-group">
...
<div class="panel panel-default">
   ...
   <!-- *********************** warehouses report ************************** -->
        <div class="row rangeStat" style="margin-top:50px;margin-bottom: 100px;">
          <h3 class="col-sm-12"><i class="fa fa-pie-chart"></i> <?=label("StockStats")?></h3>
          <div class="col-md-5">
             <div class="form-group">
                 <label for="customerSelect"><?=label('SelectStore');?></label>
...
<!--[ footer ] 
<div id="footer" style="background-color: #093457;width: 100%;">
  <div class="container">
    <p class="footer-block" style="margin: 20px 0;color:#fff;"><?=label('title');?> <?= $this->setting->companyname;?>. <?=label('version');?> <a target="_blank" href="#">BeysSoft</a></p>
  </div> -->
</div>
...
<script>
  function PrintReport() {
    ...
    newWindow.document.write(printDivCSS + '<div class="container">' + document.getElementById("PrintRep").innerHTML + '</div>');
    ...
    <div class="modal-dialog modal-lg" role="document" id="statsModal">
       <div class="modal-content">
         ...
         <div class="modal-footer">
          <a class="btn btn-red" data-toggle="modal" onclick="PrintReport()" data-target="#PrintReport"><?=label("PrintReport");?> <i class="fa fa-print"></i> </a>
