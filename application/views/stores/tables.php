...
<div class="container  container-small">
   ...
   <div class="row" style="margin-top:100px;">
      ...
      <div class="row">
         <table id="table" class="table table-bordered table-primary table-responsive">
             <thead>
                <tr>
                ...
                <tr>
                   <td><?=$table->name;?></td>
                    ...
                    <td><div class="btn-group">
                          <a class="btn btn-default" href="javascript:void(0)" data-toggle="popover" data-placement="left"  data-html="true" title='<?=label("Areyousure");?>' data-content='<a class="btn btn-danger" href="<?=base_url();?>stores/deletetable/<?=$table->id;?>/<?=$storeid;?>"><?=label("yesiam");?></a>'><i class="fa fa-times"></i></a>
