<div class="container container-small">
   <div class="row" style="margin-top:100px;">
     ...
     <div class="form-group">
      ...
      <input type="email" name="email" value="<?=$store->email;?>" class="form-control" required id="email" placeholder="<?=label("Email");?>">
    </div>
     <div class="form-group">
      <label for="StorePhone"><?=label("StorePhone");?></label>
      <input type="text" name="phone" value="<?=$store->phone;?>" class="form-control" required id="StorePhone" placeholder="<?=label("StorePhone");?>">
     </div>
     <div class="form-group">
      <label for="Country"><?=label("Country");?></label>
      <input type="text" name="country" value="<?=$store->country;?>" class="form-control" required id="Country" placeholder="<?=label("Country");?>">
     </div>
     <div class="form-group">
      <label for="City"><?=label("City");?></label>
      <input type="text" name="city" value="<?=$store->city;?>" class="form-control" required id="City" placeholder="<?=label("City");?>">
     </div>
     <div class="form-group">
      <label for="Adresse"><?=label("Adresse");?></label>
      <input type="text" name="adresse" value="<?=$store->adresse;?>" class="form-control" required id="Adresse" placeholder="<?=label("Adresse");?>">
     </div>
     <div class="form-group">
