 ...
 <section class="wrapper">
  ...
  <div class="col-sm-10">
   ...
   <div class="card">
    ...
    <h4 class="card-subtitle text-muted"><?=label('Customers');?></h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="form-group">
             ...
             <input type="number" value="" maxlength="5" name="discount" class="form-control" id="CustomerDiscount" placeholder="<?=label("CustomerDiscount");?>">
           </div>
      </div>
