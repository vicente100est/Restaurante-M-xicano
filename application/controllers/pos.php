...

{
...

    {
        ...
        foreach ($posales as $posale) {
            ...
            $ticket .= '<tr><td style=" width:100%;">' . $i . '--' . $posale->name . '--' . $posale->qt . '--' . number_format((float)($posale->qt * $posale->price), $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr>';
        ...
        $ticket .= '</tbody></table><table class="table" cellspacing="0" border="0" style="margin-bottom:8px;"><tbody><tr><td style="text-align:left;"><strong>' . label("TotalItems") . ': ' . $sale->totalitems . '</strong></td></tr><tr><td style="text-align:left; padding-left:1.5%;"><strong>' . label("Total") . ': ' . $sale->subtotal . ' ' . $this->setting->currency . '</strong></tr></tr>';
        ...
        if (intval($sale->discount))
            ...
            $ticket .= '<tr><td style="text-align:left; padding-left:1.5%;"></td><td style="text-align:right;font-weight:bold;"></td><td style="text-align:left;">' . label("Discount") . '--' . $sale->discount . '</td></tr>';
        ...
        if (intval($sale->tax))
            ...
            $ticket .= '<tr><td style="text-align:left; padding-left:1.5%;"><strong>' . label("tax") . ': ' . $sale->tax . '%</strong></td></tr>';
        ...
        $ticket .= '<tr><td colspan="1" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("GrandTotal") . ': ' . number_format((float)$sale->total, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr><tr>';
        ...
        switch ($PayMethode[0]) {
            ...
            case '1': // case Credit Card
                ...
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCard") . ': xxxx xxxx xxxx ' . substr($PayMethode[1], - 4) . '</td></tr><tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("CreditCardHold") . '--' . $PayMethode[2] . '</td></tr></tbody></table>';
            ...
            case '2': // case ckeck
                ...
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("ChequeNum") . ': ' . $PayMethode[1] . '</td></tr></tbody></table>';
                break;
            ...
            default:
                ...
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Paid") . ': ' . number_format((float)$sale->paid, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr><tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Change") . ': ' . number_format((float)(floatval($sale->paid) - floatval($sale->total)), $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr></tbody></table>';

        }



        $ticket .= '<div style="border-top:1px solid #000; padding-top:10px;"><span class="float-left">' . $store->name . '---</span><span class="float-left">' . label("Tel") . ' ' . ($store->phone ? $store->phone : $this->setting->phone) . '</span><div style="clear:both;"><center><img style="margin-top:30px" src="' . site_url('pos/GenerateBarcode/' . sprintf("%05d", $sale->id) . '/' . $bcs . '/' . $height . '/' . $width) . '" alt="' . $sale->id . '" /></center><p class="text-center" style="margin:0 auto;margin-top:10px;">' . $store->footer_text . '</p><div class="text-center" style="background-color:#000;padding:5px;width:85%;color:#fff;margin:0 auto;border-radius:3px;margin-top:20px;">' . $this->setting->receiptfooter . '</div></div>';
...

   {
      ...
      foreach ($posales as $posale) {
           ...
           //$ticket .= '<tr><td style="text-align:center; width:20px;">' . $i . '</td><td style="text-align:left; width:180px;">' . $posale->name . '<br><span style="font-size:12px;color:#666">'.$posale->options.'</span></td><td style="text-align:center; width:50px;">' . $posale->qt . '-->'. number_format((float)($posale->qt * $posale->price), $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr>';
