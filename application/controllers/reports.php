...
class Reports extends CI_Controller
{
    ...
    public function getCustomerReport()
    {
        ...
        $totals = 0;
        $sales = Sale::find_by_sql("SELECT * FROM `food_sales` WHERE client_id = '$client_id' AND created_at between '$start' AND '$end' ORDER BY created_at");
    ...
    public function getProductReport()
    {
        ...
        $prducts = Sale_item::find_by_sql("SELECT * FROM `food_sale_items` WHERE product_id = '$product_id' AND date between '$start' AND '$end' ORDER BY date");
    ...
    public function getRegisterReport()
    {
        ...
        $end = $this->input->post('end');
        $TotalRevenue = 0;
        $register = Register::find_by_sql("SELECT * FROM `food_registers` WHERE store_id = '$store_id' AND date between '$start' AND '$end' ORDER BY date");
