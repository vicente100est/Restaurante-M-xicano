...

    {
       ...
       // $ticket = '<div class="col-md-12"><div class="text-center">' . $this->setting->receiptheader . '</div><div style="clear:both;"><h4 class="text-center">' . label("SaleNum") . '.: ' . sprintf("%05d", $sale->id) . '</h4> <div style="clear:both;"></div><span class="float-left">' . label("Date") . ': ' . $sale->created_at->format('d-m-Y') . '</span><div style="clear:both;"><span class="float-left">' . label("Customer") . ': ' . $sale->clientname . '</span><div style="clear:both;"></div><table class="table" cellspacing="0" border="0"><thead><tr><th><em>#</em></th><th>' . label("Product") . '</th><th>' . label("Quantity") . '</th><th>' . label("SubTotal") . '</th></tr></thead><tbody>';
        ...
        foreach ($posales as $posale) {
            ...
            //$ticket .= '<tr><td style="text-align:center; width:15px;">' . $i . '</td><td style="text-align:left; width:90px;">' . $posale->name . '</td><td style="text-align:center; width:25px;">' . $posale->qt . '</td><td style="text-align:right; width:35px; ">' . number_format((float)($posale->qt * $posale->price), $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr>'; 
            $i ++;
       ...
       //$ticket .= '</tbody></table><table class="table" cellspacing="0" border="0" style="margin-bottom:8px;"><tbody><tr><td style="text-align:left;">' . label("TotalItems") . '->'.$sale->totalitems.'</td><td style="text-align:left; padding-left:1.5%;">' . label("Total") . '->'. number_format((float)$sale->subtotal, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency.'</td></tr>';
        ...
        if (intval($sale->tax))
          ...
          // $ticket .= '<tr><td style="text-align:left;"></td><td style="text-align:right; padding-right:1.5%;font-weight:bold;"></td><td style="text-align:left; padding-left:1.5%;">' . label("tax") . '->'.$sale->tax .'</td></tr>';
       ...
       // $ticket .= '<tr><td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("GrandTotal") . '->'.number_format((float)$sale->total, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency.'</td></tr><tr>';
        ...
        switch ($PayMethode[0]) {
            ...
            case '2': // case ckeck
                ...
                $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("ChequeNum") . '->'. $PayMethode[1] .'</td></tr>';
            ...
            default:
               ...
               $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Paid") . ' (' . label("Cash") . ')->'. number_format((float)$sale->firstpayement, $this->setting->decimals, '.', '') . ' ' . $this->setting->currency . '</td></tr>';
          ...
          foreach ($payements as $pay) {
             ...
             switch ($PayMethode[0]) {
                ...
                default:
                    ...
                    $ticket .= '<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">' . label("Paid") . ' (' . label("Cash") . ')-></td></tr>';
