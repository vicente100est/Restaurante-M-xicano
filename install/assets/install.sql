...
--
-- Structure de la table `food_categorie_expences`
--

DROP TABLE IF EXISTS `food_categorie_expences`;
CREATE TABLE IF NOT EXISTS `food_categorie_expences` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `food_combo_items`
--

DROP TABLE IF EXISTS `food_combo_items`;
...
--
-- Structure de la table `food_customers`
--
...
--
-- Structure de la table `food_expences`
--

DROP TABLE IF EXISTS `food_expences`;
CREATE TABLE IF NOT EXISTS `food_expences` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
...
--
-- Structure de la table `food_holds`
--

DROP TABLE IF EXISTS `food_holds`;
CREATE TABLE IF NOT EXISTS `food_holds` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `food_payements`
--

DROP TABLE IF EXISTS `food_payements`;
CREATE TABLE IF NOT EXISTS `food_payements` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `paid` float NOT NULL,
...
--
-- Structure de la table `food_posales`
--

DROP TABLE IF EXISTS `food_posales`;
CREATE TABLE IF NOT EXISTS `food_posales` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
...
--
-- Structure de la table `food_products`
--
...
--
-- Structure de la table `food_purchases`
--
...
--
-- Structure de la table `food_purchase_items`
--
...
--
-- Structure de la table `food_registers`
--

DROP TABLE IF EXISTS `food_registers`;
CREATE TABLE IF NOT EXISTS `food_registers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `food_sales`
--
...
--
-- Structure de la table `food_sale_items`
--

DROP TABLE IF EXISTS `food_sale_items`;
CREATE TABLE IF NOT EXISTS `food_sale_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sale_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `name` varchar(200) NOT NULL,
...
--
-- Structure de la table `food_settings`
--
...
--
-- Structure de la table `food_stocks`
--
...
--
-- Structure de la table `food_stores`
--
...
--
-- Contenu de la table `food_stores`
--
...
--
-- Structure de la table `food_suppliers`
--
...
--
-- Structure de la table `food_tables`
--

DROP TABLE IF EXISTS `food_tables`;
...
--
-- Structure de la table `food_users`
--
...
--
-- Contenu de la table `food_users`
--

INSERT INTO `food_users` (`id`, `username`, `firstname`, `lastname`, `hashed_password`, `email`, `role`, `last_active`, `avatar`, `created_at`) VALUES
...
--
-- Structure de la table `food_variations`
--
...
--
-- Structure de la table `food_waiters`
--

DROP TABLE IF EXISTS `food_waiters`;
CREATE TABLE IF NOT EXISTS `food_waiters` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL,
  `phone` varchar(30) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
...
--
-- Structure de la table `food_warehouses`
--

DROP TABLE IF EXISTS `food_warehouses`;
CREATE TABLE IF NOT EXISTS `food_warehouses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `food_zones`
--

DROP TABLE IF EXISTS `food_zones`;
