...
?>
		            ...
		            <li class="active"><a>Checklist<p>Pre-Install Checklist</p></a></li>
						<li class=""><a>Database<p>Database Config</p></a></li>
						<li class=""><a>Site Config<p>Application Config</p></a></li>
...
<?php
	...
	case "1": ?>
	<ul class="nav nav-tabs">
		<li class=""><a>Checklist<p>Pre-Install Checklist</p></a></li>
								...
								if($_POST) {
												...
												if($core->validate_post($_POST) == true)
												{
													...
													if($database->create_database($_POST) == false) {
														echo "<p style='color:#ED5565'>The database could not be created, please verify your settings.</p>";
														$error = 1;
													} else if ($database->create_tables($_POST) == false) {
														echo "<p style='color:#ED5565'>The database tables could not be created, please verify your settings.</p>";
														$error = 1;
													} else if ($core->write_database($_POST) == false) {
														echo "<p style='color:#ED5565'>The database configuration file could not be written, please chmod application/config/database.php file to 777</p>";
														$error = 1;
													}
...
<?php
	...
	<ul class="nav nav-tabs">
		<li class=""><a>Checklist<p>Pre-Install Checklist</p></a></li>
		<li class=""><a>Database<p>Database Config</p></a></li>
		<li class="active"><a>Site Config<p>Application Config</p></a></li>
		<li class=""><a>Done<p>success !</p></a></li>
	</ul>
<div class="tab-content">
					<div class="tab-pane fade in active" id="Config">
						<fieldset>
							<p style="margin-bottom:10px;font-size:13px;padding:3px;background-color:#1ABC9C;color:white" class="<?=$hide;?>"><i class='fa fa-check' style="margin:0 7px" aria-hidden='true'></i>Connection to MYSQL successful! (Database config written to the database file.).</p>
						  <legend style="padding-top:20px">Site Config</legend>
						<form id="install_form" method="post" action="?step=2">
							<?php if($_POST){
								...
								$settings = mysqli_query($con,"INSERT INTO food_settings (`id`, `companyname`, `phone`, `currency`, `receiptfooter`, `theme`, `tax`, `timezone`, `language`, `keyboard`, `stripe`) VALUES (1, '$company', '$phone', '$currency', 'Thank you for your business', 'Light', '$tax', '$timezone', 'english', '1', '0');");
				if(!$settings){echo "<div class='label label-danger'>Error while saving settings to database!</div>";}else if ($core->write_config($domain) == false) {
						...
						echo '<a href="index.php?step=3" class="label label-success" style="float:right;font-size:20px;"> success go to the next step </a>';
						$hide = 'hide';
				}
								}
							?>
...
<div class="tab-content">
					<div class="tab-pane fade in active" id="Done">
						...
						<div style="margin-bottom:10px;font-size:13px;padding:3px;background-color:#1ABC9C;color:white"><i class='fa fa-check' style="margin:0 7px" aria-hidden='true'></i> You can login now using the following credential:<br /><br />
            Username: <span style="font-weight:bold; letter-spacing:1px;">admin</span><br />Password: <span style="font-weight:bold; letter-spacing:1px;">password</span><br /><br /></div>
            <div class="bg-warning"><i class='icon-warning-sign'></i> Please don't forget to change username and password.</div>
